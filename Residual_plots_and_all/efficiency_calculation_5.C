...
TFile *file=new TFile("histograms/final_histograms_l5_data.root","RECREATE");
...
TH1F *residual[4][2][10];
TH1F *residual_all[4][2];
TH1F *clusterposition[4][2];
TH1F *interceptposition[4][2];
TH1F *angleuv[4][2];
TH2F *residual_clspos[4][2];
TH2F *uv_id[4][2];
for(int p=0;p<4;p++){
  for(int t=0;t<2;t++){
    for(int q=0;q<10;q++){
