#include<cmath>
/*612V 613V 611V 614V 611V*/
void fit_residualplot_8(TString fname="../Input_rootfile/data_bhabha_l6.root") {
...
for(int i=0;i<nentries;i++){
   ...
   if(TMath::Abs(intercept-cls)>0.050) continue;////0.08 for all except 612V
  if(layer==6 && sensor==5 && svd>0 && pxd>0 && side==0){ 
...
RooPlot *myframe = x.frame(Name("615V"),Title("615V residual distribution"),Bins(60));
data->plotOn(myframe);
