#include<cmath>
/*512U 513U 514U*/
void fit_residualplot_5(TString fname="../Input_rootfile/data_bhabha_l5.root") {
using namespace RooFit;
RooRealVar x("resolution", " residual in cm",-0.025, 0.025);
...
for(int i=0;i<nentries;i++){
   ...
   if(TMath::Abs(intercept-cls)>0.015) continue;//0.015 for 513U: 0.025 for 512U:0.018 for 514U
  if(layer==5 && sensor==4&& svd>0 && pxd>0 && side==1){ 
...
RooPlot *myframe = x.frame(Name("514U"),Title("514U residual distribution"),Bins(60));
data->plotOn(myframe);
