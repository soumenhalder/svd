#include<cmath>
/*412U 413U*/
void fit_residualplot_3(TString fname="../Input_rootfile/data_bhabha_l4.root") {
...
for(int i=0;i<nentries;i++){
   ...
   if(TMath::Abs(intercept-cls)>0.020) continue;
  if(layer==4 && sensor==2 && svd>0 && pxd>0 && side==1){ 
...
RooPlot *myframe = x.frame(Name("412U"),Title("412U residual distribution"),Bins(60));
data->plotOn(myframe);
